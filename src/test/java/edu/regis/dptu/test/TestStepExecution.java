...
/**
 * A simple standalone test class for verifying LCSProblem step execution.
 * Run this class to test if the step(), undo(), and reset() methods are working correctly.
 * 
 * @author [your name]
 */
public class TestStepExecution implements ProblemListener {
    ...
    public void problemUpdated(Problem problem) {
        System.out.println("LISTENER: Problem updated notification received. Current line: " + 
