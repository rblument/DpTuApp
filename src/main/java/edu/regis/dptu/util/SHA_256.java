 ...
 *
 * <p>See sha256(String). For example sha256("Regis Computer Science Rocks!") returns
 * fddfe0c1671993dbe8da88ccfbdf8aae3ae255d41b2808ff86041cca4cff65e5
 *
 * <p>This code was originally in the public domain and has been modified since.
 *
 * @author rickb
 * @author unknown
 */
public class SHA_256 {
    ...
    /**
     * <b>Internal method, no need to call.</b> Pads the given message to have a length that is a
     * multiple of 512 bits (64 bytes), including the addition of a 1-bit, k 0-bits, and the message
     * length as a 64-bit integer. The result is a 32-bit integer array with big-endian byte
     * representation.
     *
    ...
    /**
     * Converts the given int array into a byte array via big-endian conversion (1 int becomes 4
     * bytes).
     *
