...
public class CodeView extends GPanel {
    ...
    private void layoutComponents() {
        addc(codeview, 0, 0, 0, 0, 1.0, 1.0,
                GridBagConstraints.NORTH, GridBagConstraints.HORIZONTAL,
                10, 250, 10, 0);
        addc(nextButton, 0, 0, 0, 0, 1.0, 1.0,
                GridBagConstraints.ABOVE_BASELINE, GridBagConstraints.HORIZONTAL,
                0, 250, 10, 0);
        addc(autoButton, 0, 0, 0, 0, 1.0, 1.0,
    ...
    /**
     * This renders the lines of the code, one line at a time
     * Needs 2 "blank" (single space) lines after nested for loop
     * 
     * @param evt 
     */
