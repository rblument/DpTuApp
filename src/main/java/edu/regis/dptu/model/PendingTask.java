 ...
 *
 * <p>A pending task represents the dynamic information associated with a student completing a task,
 * while the associated task is a static step within a course.
 *
 * @author rickb
 */
public class PendingTask {
     ...
     *
     * @return true if all of the steps in this task have been completed, otherwise false
     */
