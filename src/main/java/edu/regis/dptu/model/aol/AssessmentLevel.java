...
public enum AssessmentLevel {
    ...
    /**
     * Indicates a student has been exposed to an Outcome, but hasn't demonstrated any knowledge of
     * it.
     */
    LOW("Low"),

    /** Indicates a student has demonstrated appropriate knowledge of an outcome one time. */
    MEDIUM("Medium"),

    /** Indicates a student has demonstrated appropriate knowledge of an outcome multiple times. */
    HIGH("High"),
