 ...
 *
 * <p>As a Timeout may appear as an action or expectation created by an agent, all fields are final
 * so that other malicious agents cannot change them.
 *
 * @author rickb
 */
public class Timeout {
    ...
    /**
     * Text that can be displayed to the user that describes this event and what they need to do, if
     * anything.
     */
     ...
     * @param text the text, if any, displayed to the student when this timeout triggers
     */
