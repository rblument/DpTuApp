...
public enum TaskKind {
     ...
     * task specifies what kind of DP problem.)
     */
    ...
    /**
     * This is a specific cell value identified by an i,j value in during the i_j_loop of the
     * algorithm.
     */
    ...
    /** The task of tracing a path through the dynamic programming table to identify the solution */
