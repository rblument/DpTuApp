...
public class KnowledgeComponent extends TitledModel {
     ...
     *
     * <p>For Macroadaptation, the exercising locations must be used to select tasks that addresses
     * this component. They can also be used for OTHER, but with this approach, the component was
     * addressed in a task that is part of the fixed sequenced, for example, of a unit.
     */
    protected TaskSelectionKind pedagogy;

    /**
     * If true, this outcome represents a knowledge component associated with the SHA-256
     * application and its underlying concepts, otherwise, it represents knowledge related to using
     * the tutor/GUI itself.
     */
