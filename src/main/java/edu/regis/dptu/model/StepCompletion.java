 ...
 * @author rickb
 */
@SuppressWarnings("Logging") // Value object / completion record
public class StepCompletion {
    ...
    /**
     * Set the time the associated step was completed (to only be used by the database when
     * restoring a step completion).
     *
