...
public class StepCompletionReply {
     ...
     *
     * <p>If true, data contains a JSon encoded Step object.
     */
    private boolean isRepeatStep;

    /**
     * The tutor believes the student understands the previous step and is requesting the student to
     * complete a new Task.
     *
     * <p>If true, data contains a JSon encoded Task object.
     */
    private boolean isNewTask;

    /**
     * The tutor is requesting the student to perform the following step, which might be a new
     * example.
     *
     * <p>If true, data contains a JSon encoded Step object.
     */
    ...
    /**
     * Tutor is asking the student to perform the next step in the current (previous) task.
     *
     * <p>If true, data contains a Json encoded Step object.
     */
