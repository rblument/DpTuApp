...
public interface StudentSvc {
     ...
     *
     * @param student the student's email address is used as the student id (email:
     *     user@university.edu)
     ...
     *
     * <p>The idea is that this will execute quickly since it avoid loading the student model.
     *
     ...
     *
     * <p>See exists(String) for a faster check as to whether a student exists.
     *
     * @param userId the student's user id (email: user@university.edu)
     ...
     * @throws NonRecoverableException perhaps see getCause().getErrorCode()
     */
    StudentModel findModelById(String userId) throws ObjNotFoundException, NonRecoverableException;

    /**
     * Delete the student from the database including the student's account, current session, and
     * student model.
     *
     * @param userId the student's user id (email: user@university.edu)
     * @throws NonRecoverableException
