...
public class DpTuTutor implements TutorSvc {
     ...
     * 
     * <p> this method is inv oked via reflection by {@link #request(ClientRequest)}
     * when the request type is ":CompletedTask"
     * The request() method is responsible for verifying the user's session
     * 
     * <p> on success this method persists the user,task completion record so that
     * progress can be reconstructed across sessions (for progress bars)
     * 
