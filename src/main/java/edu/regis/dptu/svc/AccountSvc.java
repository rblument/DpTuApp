...
public interface AccountSvc {
     ...
     *
     * @param account the account that is being updated (the new information in in this account).
    ...
    /**
     * Check if an account with the given user id exists in the database. (less expensive then using
     * retrieve).
     *
