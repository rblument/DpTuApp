...
/**
 * A decorator that wraps a user interface request being sent to the tutor (sever), which includes
 * the type of request being mad.
 *
...
public class ClientRequest {
    ...
    /**
     * A JSon encoded object whose format depends on the associated request. (See the requestType
     * documentation.)
     */
    private String data;
     ...
     *
     * @return a JSon encoded object corresponding to the request type. See the documentation for
     *     the data field.
     */
     ...
     * Set the data.
     *
     * @param data a JSon encoded object corresponding to the request type. See the documentation
     *     for the data field.
     */
