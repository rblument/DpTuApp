...
public interface SessionSvc {
     ...
     * @throws IllegalArgException a session for the associated student account already exists.
    ...
    /**
     * Return the session with the specified id (this is a full session with all events versus a
     * digest).
     *
     ...
     * @throws NonRecoverableException perhaps see getCause().getErrorCode().
     */
    String retrieveSecurityToken(String userId)
