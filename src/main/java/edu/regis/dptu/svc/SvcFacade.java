 ...
 * "data": {"userId":"userId@regis.edu", "password":"sha256Password", "firstName":"Rick",
 * "lastName":"Justice" } }
 *
 * <p>{"request": "SignIn", "data": {"userId": "user email addr"} }
 *
 * @author rickb
 */
public class SvcFacade {
    ...
    /**
     * Create the singleton for this facade, which occurs when this class is loaded by the Java
     * class loaded, as a result of the class being referenced be the SvcFacade.instance() method
     * occurring initially in the SignInAction class.
     */
    static {
     ...
     *
     * <p>That is, the DpTuServer is executing on this host.
     */
