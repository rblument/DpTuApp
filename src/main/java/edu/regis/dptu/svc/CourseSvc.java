...
public interface CourseSvc {
     ...
     *
     * <p>Use {@link #retrieve()} except it returns to return the entire course.
     *
     * @param courseId integer key of the course to load.
     ...
     * @throws ObjNotFoundException No task with the given id exists in the
     *     DB.NonRecoverableException=
     * @throws NonRecoverableException also see getCause().getErrorCode().
     */
